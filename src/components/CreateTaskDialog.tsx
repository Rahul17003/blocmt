...
export function CreateTaskDialog() {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        toast({
            title: `${values.taskName} task created.`,
            description: `Deadline is on ${values.dueDate}.`,
          })
          form.reset()
    ...
    return (
        <Dialog open={isTaskDialogOpen} onOpenChange={setIsTaskDialogOpen}>
            <DialogTrigger>
                <Button className="bg-indigo-600 hover:bg-indigo-700">Create Task</Button>
            </DialogTrigger>
                    ...
                    <CardContent className="border-none">
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)}>
                                ...
                                <div className="flex flex-col space-y-1.5">
                                    <Button type="submit" className="bg-indigo-600 hover:bg-indigo-700 mt-6"
                                    // onClick={() => {
                                    //     toast({
